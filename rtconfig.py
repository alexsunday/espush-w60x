...
W60X_ROOT = os.path.normpath(os.getenv('W60X_ROOT'))
...
if os.path.exists(os.path.abspath('./') + '/drivers'):
    ...
    gcc_linkscripts_path   = os.path.join(W60X_ROOT, 'drivers/linker_scripts/link.lds')
    armcc_linkscripts_path = os.path.join(W60X_ROOT, 'drivers/linker_scripts/link.sct')
    iar_linkscripts_path   = os.path.join(W60X_ROOT, 'drivers/linker_scripts/link.icf')
...
if PLATFORM == 'gcc':
    ...
    POST_ACTION += 'python ./makeimg.py "%s"' % W60X_ROOT
