...
W60X_ROOT = sys.argv[1]
# Setting winnermicro libraries path
# wmlib_path='../../libraries/WM_Libraries'
W60X_ROOT = os.path.normpath(W60X_ROOT)
wmlib_path= os.path.join(W60X_ROOT, "libraries/WM_Libraries")
# Setting tools path
tools_path=os.path.join(W60X_ROOT, "tools")
